...
<div class="container">
    ...
    <section class="content-header">
        <h1>
            Report
            <small>List Summary Report</small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-line-chart"></i> Report</a></li>
            <li><a href="#" class="active">List Summary Report</a></li>
        </ol>
    </section>
            ...
            <div class="box-body">
                <form role="form" class="form-horizontal">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            <label for="selectCustomer" class="col-sm-2">Product</label>
                            <div class="col-sm-3">
                    ...
                    <table class="table table-bordered table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ $value->jml_manifest }}</td>
                                <td>{{ $value->jm_pages }}</td>                                
                                <td><a href="{{ route('report.summary.cetaklist',['nobox' => $value->no_box,'id_prod' =>$value->id,'id_master' =>$value->id_master]) }}" target="_blank" class="btn btn-primary"><span class="fa fa-print" ></span> Print List-Box</a></td>                                
                            </tr>
                            @endforeach
                        </tbody>

                    </table>
                    {{ $data->withQueryString()->onEachSide(5)->links() }}
                </div>
            </div>
            <!-- /.box-body -->
        </div>
