...
@section('tittle_bar','Imaging New Business')
...
<div class="container">
    ...
    <section class="content-header">
        <h1>
            Imaging
            <small>List Data New Business</small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-file-image-o"></i> Imaging</a></li>
            <li><a href="#" class="active">List New Business</a></li>
        </ol>
    </section>
                    ...
                    <table id="example1" class="table table-bordered table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a title="Detail" href="{{ route('imaging.nb.detail',['id'=>$value->id_master,'nopol'=>$value->no_account]) }}" data-toggle="modal" data-target="#modal-default-detail{{$value->id}}"><span class="fa  fa-sticky-note-o"></span> </a>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="title-detail"><span class="fa fa-edit"></span> Detail NB {{ $value->no_account }} </h4>
            </div>
        </div>
        <!-- /.modal-content -->
    </div>
