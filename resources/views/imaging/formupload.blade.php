            ...
            <div class="modal-body">
                <form class="form-horizontal" name="form-item" id="form-item" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            <label for="cycle" class="col-sm-3 ">Pos Location</label>

                            <div class="col-sm-6">
                                <select class="form-control select2" style="width: 100%;" placeholder="pilih product" id="pos_id" name="pos_id" required>
                        ...
                        <div class="form-group">
                            <label for="inputfile" class="col-sm-3">Input List Imaging</label>
