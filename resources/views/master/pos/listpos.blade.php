    ...
    <section class="content">
        ...
        <div class="box box-success">
            <div class="box-header with-border">
                <h3 class="box-title">                    
                    <a href="{{ route('master.form.pos') }}" type="button" class="btn bg-olive margin" ><span class="fa fa-upload"></span> Add Pos</a>                    
                </h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
                                ...
                                <td>
                                    <div class="input-group-btn margin">
                                        ...
                                        <ul class="dropdown-menu">                                            
                                            ...
                                            <li><a href="{{ route('master.pos.edit',$value->id) }}"><span class="fa fa-edit"></span> Edit</a></li>
                                            @endif                                             
                                            @if(Auth::user()->group_id == 1)
                                            <li><a href="{{ route('master.del.pos',$value->id) }}"><span class="fa fa-remove"></span> Delete</a></li>
                                            @endif                                           
                                        </ul>
                                    </div>
                                </td>
