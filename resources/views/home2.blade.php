...
<div class="container">
    ...
    <section class="content">
        ...
        <div class="box box-success">
            <div class="box-header with-border">
                <h3 class="box-title">Log Actvity User</h3>
            </div>
            <div class="box-body">
                <div class="row mt">
                    <div class="col-lg-12">
                        <div class="panel-body">
                            <div class="card-body table-responsive p-0" style="table-layout: fixed;">
...
<script>
    ...
    function showLog() {
        $('#viewlog').empty();
        $.get('getlogactivity', function(data, status) {
            var html = '';
            for (var x in data.data) {
                html = '<tr> <td>' + data.data[x].subject + '</td> <td>' + data.data[x].name + '</td> <td>' + data.data[x].created_at + '</td> </tr>';
                document.getElementById('viewlog').innerHTML += html;
            }
            //document.getElementById('viewlog').appendChild(html);
            //console.log(html);
        });
    }
